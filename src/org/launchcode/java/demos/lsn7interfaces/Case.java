...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Fudge", 0.75, new ArrayList<>(Arrays.asList( "dairy")));
        Topping topping2 = new Topping("Nuts", 0.75, new ArrayList<>(Arrays.asList( "dairy")));
        Topping topping3 = new Topping("Caramel", 0.85, new ArrayList<>(Arrays.asList( "dairy", "red #5")));
        Topping topping4 = new Topping("Sprikles", 0.85, new ArrayList<>(Arrays.asList( "dairy", "nuts", "gelatin")));
        Topping topping5 = new Topping("Strawberry", 0.50, new ArrayList<>(Arrays.asList( "strawberry")));
